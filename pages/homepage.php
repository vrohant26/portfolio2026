...
<section id="home" class="h-full flex direction-column justify-between p-sm">

  <div class="top flex justify-end align-start">
    <div class="stacked-carousel">
      <div class="stacked-cards-container">
        ...
        if ($project_query->have_posts()) :
          ...
          while ($project_query->have_posts()) : $project_query->the_post();
            ...
            ?>
            <a href="<?php the_permalink(); ?>" class="stacked-card" data-index="<?php echo $card_index; ?>" data-title="<?php echo esc_attr(get_the_title()); ?>" aria-label="<?php the_title_attribute(); ?>">
              <?php if ($image) : ?>
      ...
      <div class="stacked-progress-container">
        <div class="stacked-progress-bar"></div>
      </div>

      <div class="stacked-carousel-footer">
        <a href="<?php echo esc_url( home_url( '/featured-work' ) ); ?>" class="fs-xs scramble text-light">View Projects</a>
      </div>
    </div>
  </div>

  <div class="bottom flex direction-column gap-md justify-end">
    <div class="brief">
